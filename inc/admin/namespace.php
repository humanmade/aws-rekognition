...
function bootstrap() {
	if ( ! current_user_can( 'update_rekognition_labels' ) ) {
		return;
	}
...
function output_metabox( WP_Post $post ) {
	...
	<button class="button button-secondary hm-aws-rekognition-update-labels"><?php _e( 'Re-process', 'hm-aws-rekognition' ) ?></button>
	<?php
}
